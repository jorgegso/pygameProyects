...
def crear_auricular(pantalla , x, y ):
    pygame.draw.circle(pantalla, ROJO , [ 350 - 275 + x, 150 - 75  + y], 40, )
    pygame.draw.circle(pantalla, GRIS , [410 - 275 + x, 150 - 75 + y], 25 )    
    pygame.draw.circle(pantalla, GRIS , [  290 - 275 + x, 150 - 75  + y], 25 )
    pygame.draw.arc(pantalla, GRIS ,[  275 - 275+ x , 75 - 75 + y, 150, 125], 0 , pi/1 , 8)    
    pygame.draw.arc(pantalla, NEGRO, [325 - 275 + x, 160 - 75  + y, 50, 15], pi,4*pi/2, 4)    
    pygame.draw.circle(pantalla, AZUL , [ 330 - 275 + x,  140 - 75  + y], 9) 
    pygame.draw.circle(pantalla, AZUL , [365 - 275 + x , 140  - 75 + y], 9)    
...
pygame.mouse.set_visible(False) se ve el mouse
